...
{
	us.description =	"DSNTree 1.02 - Converts a DSN file to CSV, increasing its readibility.";
	us.set_syntax("DSNTree.exe " + FILE_ARG + " [/o:" + EXTENSION_ARG + "] [/c:" + CONVERT_ARG + "] [/x:" + XMLDOC_ARG + "] [/t] [/v]");
